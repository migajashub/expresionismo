                ...
                <div class="contenedor_entrecolor">
                    ...
                    <div class="encuadrado">
                        <div class="doscolumnas">
                                ...
                                $dia=date("l");
                                $obras = [
                                "Monday" => ["h2" => "Artisin", "p" => "Ernst Ludwig Kirchner, 1910", "img" => "img/kirchner_artisin-marcella_1910.jpg", "a" => "kirchner.php"],
                                "Tuesday"=> ["h2" => "Cuatro bañistas", "p" => "Ernst Ludwig Kirchner, 1910", "img" => "img/kirchner_cuatro-bañistas_1910.jpg", "a" => "kirchner.php"],
                                "Wednesday"=> ["h2" => "El sueño", "p" => "Franz Marc, 1912", "img" => "img/marc_el-sueño_1912.jpg", "a" => "marc.php"],
                                "Thursday"=> ["h2" => "Casas en Munrau", "p" => "Vasily Kandinsky, 1909", "img" => "img/kandinsky_casas-murnau_1909.jpg"], "a" => "kandisnky.php",
                                "Friday"=> ["h2" => "Afueras de Murnau", "p" => "Gabriele Münter, 1908", "img" => "img/munter_afueras-murnau_1908.jpg", "a" => "munter.php"],
                                "Saturday"=> ["h2" => "Landschaft im Herbst", "p" => "Karl Schmidt-Rottluff, 1910", "img" => "img/Saturday.jpg", "a" => "schmidt-rottluff.php"],
                                "Sunday"=> ["h2" => "Dos hombres en una mesa", "p" => "Erich Heckel, 1913", "img" => "img/heckel_hombres-mesa_1913.jpg", "a" => "heckel.php"],
                                ];
                                $obra = $obras[$dia];
                                ...
                                echo "<h2>{$obra['h2']}</h2>";
                                echo "<p>{$obra['p']}</p>";
                                echo "<br><a href='{$obra["a"]}'>Sobre este artista</a>";
                                echo "</div>";
                                ?>
                            </div>
                        </div>
